...
class CalendarDisplayed extends StatelessWidget {  
  ...
  final ThemeColor configData;
  CalendarDisplayed({Key key, this.screenWidth, this.screenHeight, this.events, this.schoolSkipped, this.rolledDays, this.readableSchedule, this.configData}) : super(key: key);
